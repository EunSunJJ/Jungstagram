				...
				<div class="join-box">
					...
					<div class="join-input">
						<div>
							<div class="d-flex">
								<input type="text" placeholder="로그인 아이디"
									class="loginId-input-box my-4 ml-5 mr-2" id="loginIdInput">
								<button class="btn btn-info my-4" id="isDupliateBtn">중복확인</button>
							</div>
						...
						<input type="text" placeholder="이메일 주소"
							class="login-input-box mb-4 ml-5" id="emailInput"> <input
							type="text" placeholder="이름" class="login-input-box mb-4 ml-5"
							id="nameInput"> <input type="text" placeholder="닉네임"
							class="login-input-box mb-4 ml-5" id="nicknameInput"> <input
							type="password" placeholder="비밀번호"
							class="login-input-box mb-4 ml-5" id="passwordInput">

						<button type="button" class="btn btn-info btn-block ml-5"
							id="joinBtn">가입</button>
					</div>
				</div>

				<div
					class="join-box-bottom d-flex justify-content-center align-items-center">
					<div>
